...
export const IMPORT_SCHEMAS={
  sales:{title:'销售数据',columns:[sku,name,qty],maxRows:5000},
  monthlyPlan:{title:'月度备货计划',maxRows:1000,columns:[sku,name,col('qty','备货数量',['数量','提交数量','计划数量','需求数量','Quantity','Jumlah'],true,'positive'),col('reason','调整原因',['原因','备货原因','备注','Reason'],false,'text',240)]},
