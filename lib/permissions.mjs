...
const ADMIN_PERMISSIONS = Object.keys(PERMISSION_LABELS).filter((key) => !["sales.import","plan.submit"].includes(key));
...
export const ROLE_PERMISSIONS = Object.freeze({
  ...
  "供应链":Object.freeze(["wholesale.read","wholesale.ship","wholesale.return","plan.submit","approval.withdraw","sku.manage","master.manage","purchase.confirm","production.qc","inventory.count.approve","inventory.hold.resolve","shipment.create","shipment.advance.supply","inbound.receive","transport.create","transport.advance.supply","transport.receive"]),
